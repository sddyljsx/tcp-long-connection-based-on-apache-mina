 ...
 * {@link DecodingState#decode(org.apache.mina.core.buffer.IoBuffer, ProtocolDecoderOutput)} buffers decoded
 * messages in a {@link java.util.List}. Once the state machine has reached its end state
 * this class will call {@link #finishDecode(java.util.List, ProtocolDecoderOutput)}. The
