 ...
 * existing {@link org.apache.mina.core.session.IoSession}s won't get affected by the changes in this builder.
 * {@link IoFilterChainBuilder}s affect only newly created {@link org.apache.mina.core.session.IoSession}s.
 *
 * <pre>
 * IoAcceptor acceptor = ...;
...
public class DefaultIoFilterChainBuilder implements IoFilterChainBuilder {
     ...
     * a {@link java.util.Map} implementation that iterates the filter mapping in the
     * order of insertion such as {@link java.util.LinkedHashMap}.  Otherwise, it will
