...
public class Subnet {
     ...
     * 192.168.0.0/24 would be created using the {@link java.net.InetAddress}
     * 192.168.0.0 and the mask 24.
     * @param subnet The {@link java.net.InetAddress} of the subnet
     * @param mask The mask
     */
    ...
    /**
     * Checks if the {@link java.net.InetAddress} is within this subnet
     * @param address The {@link java.net.InetAddress} to check
