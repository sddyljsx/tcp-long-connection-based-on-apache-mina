...
/**
 * A thread-safe version of {@link java.util.Map} in which all operations that change the
...
public class CopyOnWriteMap<K, V> implements Map<K, V>, Cloneable {
    ...
    /**
     * This method will return a read-only {@link java.util.Set}.
     */
    public Set<K> keySet() {
    ...
    /**
     * This method will return a read-only {@link java.util.Collection}.
     */
