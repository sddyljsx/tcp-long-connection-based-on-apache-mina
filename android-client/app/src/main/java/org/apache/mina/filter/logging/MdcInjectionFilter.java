 ...
 * </ul>
 *
 * User code can also add custom properties to the context, via {@link #setProperty(org.apache.mina.core.session.IoSession, String, String)}
 *
...
public class MdcInjectionFilter extends CommonEventFilter {
     ...
     * You could still add custom keys via {@link #setProperty(org.apache.mina.core.session.IoSession, String, String)}
