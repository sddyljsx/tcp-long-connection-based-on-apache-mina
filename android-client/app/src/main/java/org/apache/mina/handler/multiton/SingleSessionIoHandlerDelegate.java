...
/**
 * An {@link org.apache.mina.core.service.IoHandler} implementation which delegates all requests to
 ...
 * created session.
 *
 * WARNING : This {@link org.apache.mina.core.service.IoHandler} implementation may be easier to understand and
...
public class SingleSessionIoHandlerDelegate implements IoHandler {
    ...
    /**
     * Delegates the method call to the
     * {@link SingleSessionIoHandler#sessionIdle(org.apache.mina.core.session.IdleStatus)} method of the
