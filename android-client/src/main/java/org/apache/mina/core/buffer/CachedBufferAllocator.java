 ...
 * <p>
 * In {@link SimpleBufferAllocator}, the underlying {@link java.nio.ByteBuffer} of
 * the {@link IoBuffer} is reallocated on its capacity change, which means
 * the newly allocated bigger {@link java.nio.ByteBuffer} replaces the old small
 * {@link java.nio.ByteBuffer}.  Consequently, the old {@link java.nio.ByteBuffer} is marked
 ...
 * VM and the cost of filling the newly allocated {@link java.nio.ByteBuffer} with
