...
/**
 * A factory that creates and configures a new {@link java.security.KeyStore} instance.
 *
...
public class KeyStoreFactory {
    ...
    /**
     * Creates a new {@link java.security.KeyStore}. This method will be called
     * by the base class when Spring creates a bean using this FactoryBean.
     *
     * @return a new {@link java.security.KeyStore} instance.
     */
     ...
     * Sets the data which contains the key store.
     *
     * @param dataStream the {@link java.io.InputStream} that contains the key store
     */
     ...
     * Sets the data which contains the key store.
     *
     * @param dataFile the {@link java.io.File} that contains the key store
     */
     ...
     * Sets the data which contains the key store.
     *
     * @param dataUrl the {@link java.net.URL} that contains the key store.
     */
