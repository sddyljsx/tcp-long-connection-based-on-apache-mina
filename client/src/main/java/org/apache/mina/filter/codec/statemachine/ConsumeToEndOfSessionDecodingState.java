...
/**
 * {@link DecodingState} which consumes all received bytes until the session is closed.
 *
...
public abstract class ConsumeToEndOfSessionDecodingState implements DecodingState {
     ...
     *
     * @param maxLength the maximum number of bytes which will be consumed. If this max is reached a
     *                  {@link ProtocolDecoderException} will be thrown by {@link #decode(IoBuffer,
