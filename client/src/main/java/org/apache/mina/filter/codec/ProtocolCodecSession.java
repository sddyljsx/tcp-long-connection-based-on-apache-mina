...
/**
 * A virtual {@link IoSession} that provides {@link ProtocolEncoderOutput} and {@link
 * ProtocolDecoderOutput}.  It is useful for unit-testing codec and reusing codec for
 * non-network-use (e.g. serialization).
 *
 * <h2>Encoding</h2>
 * <pre>
...
public class ProtocolCodecSession extends DummySession {
    ...
    /**
     * Returns the {@link ProtocolEncoderOutput} that buffers {@link IoBuffer}s generated by {@link
     * ProtocolEncoder}.
     */
    ...
    /**
     * Returns the {@link ProtocolEncoderOutput} that buffers messages generated by {@link
     * ProtocolDecoder}.
     */
