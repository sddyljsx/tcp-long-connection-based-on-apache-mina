...
/**
 * An {@link IoFilter} which translates binary or protocol specific data into message objects and
 * vice versa using {@link ProtocolCodecFactory}, {@link ProtocolEncoder}, or {@link
 * ProtocolDecoder}.
 *
...
public class ProtocolCodecFilter extends IoFilterAdapter {
    ...
    /**
     * Creates a new instance of ProtocolCodecFilter, associating a factory for the creation of the
     * encoder and decoder.
     *
    ...
    /**
     * Creates a new instance of ProtocolCodecFilter, without any factory. The encoder/decoder
     * factory will be created as an inner class, using the two parameters (encoder and decoder).
     *
     ...
     * Creates a new instance of ProtocolCodecFilter, without any factory. The encoder/decoder
     * factory will be created as an inner class, using the two parameters (encoder and decoder),
     * which are class names. Instances for those classes will be created in this constructor.
     *
    ...
    /**
     * Process the incoming message, calling the session decoder. As the incoming buffer might
     * contains more than one messages, we have to loop until the decoder throws an exception.
     * <p>
