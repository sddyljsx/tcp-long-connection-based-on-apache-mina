 ...
 * <p>
 * If no properties are set the returned {@link SSLContext} will be equivalent to what the following
 * creates:
 * <pre>
 ...
 * </p>
 * <p>
 * Use the properties prefixed with <code>keyManagerFactory</code> to control the creation of the
 * {@link KeyManager} to be used.
 * </p>
 * <p>
 * Use the properties prefixed with <code>trustManagerFactory</code> to control the creation of the
 * {@link TrustManagerFactory} to be used.
 * </p>
 *
...
public class SslContextFactory {
    ...
    /**
     * If this is set to <code>true</code> while no {@link KeyManagerFactory} has been set using
     * {@link #setKeyManagerFactory(KeyManagerFactory)} and no algorithm has been set using {@link
     * #setKeyManagerFactoryAlgorithm(String)} the default algorithm return by {@link
     * KeyManagerFactory#getDefaultAlgorithm()} will be used. The default value of this property is
     * <tt>true<tt/>.
     *
    ...
    /**
     * If this is set to <code>true</code> while no {@link TrustManagerFactory} has been set using
     * {@link #setTrustManagerFactory(TrustManagerFactory)} and no algorithm has been set using
     * {@link #setTrustManagerFactoryAlgorithm(String)} the default algorithm return by {@link
     * TrustManagerFactory#getDefaultAlgorithm()} will be used. The default value of this property
     * is <tt>true<tt/>.
     *
     * @param useDefault <code>true</code> or <code>false</code>.
     */
    ...
    /**
     * Sets the {@link KeyManagerFactory} to use. If this is set the properties which are used by
     * this factory bean to create a {@link KeyManagerFactory} will all be ignored.
     *
    ...
    /**
     * Sets the algorithm to use when creating the {@link KeyManagerFactory} using {@link
     * KeyManagerFactory#getInstance(java.lang.String)} or {@link KeyManagerFactory#getInstance(java.lang.String,
     * java.lang.String)}.
     * <p>
     * This property will be ignored if a {@link KeyManagerFactory} has been set directly using
     * {@link #setKeyManagerFactory(KeyManagerFactory)}.
     * </p>
     * <p>
     * If this property isn't set while no {@link KeyManagerFactory} has been set using {@link
     * #setKeyManagerFactory(KeyManagerFactory)} and {@link #setKeyManagerFactoryAlgorithmUseDefault(boolean)}
     * has been set to
    ...
    /**
     * Sets the provider to use when creating the {@link KeyManagerFactory} using {@link
     ...
     * </p>
     * <p>
     * If this property isn't set and no {@link KeyManagerFactory} has been set using {@link
     * #setKeyManagerFactory(KeyManagerFactory)} {@link KeyManagerFactory#getInstance(java.lang.String)}
     * will be used to create the {@link KeyManagerFactory}.
     * </p>
     *
    ...
    /**
     * Sets the {@link KeyStore} which will be used in the call to {@link
     * KeyManagerFactory#init(java.security.KeyStore, char[])} when the {@link SSLContext} is
     * created.
     *
    ...
    /**
     * Sets the password which will be used in the call to {@link KeyManagerFactory#init(java.security.KeyStore,
     * char[])} when the {@link SSLContext} is created.
     *
    ...
    /**
     * Sets the {@link TrustManagerFactory} to use. If this is set the properties which are used by
     * this factory bean to create a {@link TrustManagerFactory} will all be ignored.
     *
     * @param factory the factory.
     */
    ...
    /**
     * Sets the algorithm to use when creating the {@link TrustManagerFactory} using {@link
     * TrustManagerFactory#getInstance(java.lang.String)} or {@link TrustManagerFactory#getInstance(java.lang.String,
     * java.lang.String)}.
     * <p>
     * This property will be ignored if a {@link TrustManagerFactory} has been set directly using
     * {@link #setTrustManagerFactory(TrustManagerFactory)}.
     * </p>
     * <p>
     * If this property isn't set while no {@link TrustManagerFactory} has been set using {@link
     * #setTrustManagerFactory(TrustManagerFactory)} and {@link #setTrustManagerFactoryAlgorithmUseDefault(boolean)}
     * has been set to
     * <code>true</code> the value returned
    ...
    /**
     * Sets the {@link KeyStore} which will be used in the call to {@link
     * TrustManagerFactory#init(java.security.KeyStore)} when the {@link SSLContext} is created.
     * <p>
     * This property will be ignored if {@link ManagerFactoryParameters} has been set directly using
    ...
    /**
     * Sets the {@link ManagerFactoryParameters} which will be used in the call to {@link
     * TrustManagerFactory#init(javax.net.ssl.ManagerFactoryParameters)} when the {@link SSLContext}
     * is created.
     *
    ...
    /**
     * Sets the provider to use when creating the {@link TrustManagerFactory} using {@link
     ...
     * </p>
     * <p>
     * If this property isn't set and no {@link TrustManagerFactory} has been set using {@link
     * #setTrustManagerFactory(TrustManagerFactory)} {@link TrustManagerFactory#getInstance(java.lang.String)}
     * will be used to create the {@link TrustManagerFactory}.
     * </p>
     *
     * @param provider the name of the provider.
     */
    ...
    /**
     * Sets the {@link SecureRandom} to use when initializing the {@link SSLContext}. The JVM's
     * default will be used if this isn't set.
     *
     * @param secureRandom the {@link SecureRandom} or <code>null</code> if the JVM's default should
     *                     be used.
     * @see SSLContext#init(javax.net.ssl.KeyManager[], javax.net.ssl.TrustManager[],
     ...
     *
     * @param serverSessionCacheSize the new session cache size limit; zero means there is no
     *                               limit.
     ...
     *
     * @param serverSessionTimeout the new session timeout limit in seconds; zero means there is no
     *                             limit.
