...
/**
 * Tells {@link KeepAliveFilter} what to do when a keep-alive response message was not received
...
public interface KeepAliveRequestTimeoutHandler {
    ...
    /**
     * Invoked when {@link KeepAliveFilter} couldn't receive the response for the sent keep alive
     * message.
     */
