...
/**
 * A {@link IoFilter} which blocks connections from connecting at a rate faster than the specified
 * interval.
 *
...
public class ConnectionThrottleFilter extends IoFilterAdapter {
     ...
     *
     * @param allowedInterval The number of milliseconds a client is allowed to wait before making
