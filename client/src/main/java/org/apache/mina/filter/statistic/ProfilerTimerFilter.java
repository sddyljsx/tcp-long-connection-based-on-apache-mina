...
/**
 * This class will measure the time it takes for a method in the {@link IoFilterAdapter} class to
 * execute.  The basic premise of the logic in this class is to get the current time at the
 * beginning of the method, call method on nextFilter, and then get the current time again.  An
 * example of how to use the filter is:
 *
 * <pre>
...
public class ProfilerTimerFilter extends IoFilterAdapter {
    ...
    /**
     * Creates a new instance of ProfilerFilter.  This is the default constructor and will print out
     * timings for messageReceived and messageSent and the time increment will be in milliseconds.
     */
    ...
    /**
     * Creates a new instance of ProfilerFilter.  This is the default constructor and will print out
     * timings for messageReceived and messageSent.
     *
     ...
     * </pre>
     * <p>
     * Note : you can add as many {@link IoEventType} as you want. The method accepts a variable
     * number of arguments.
     *
    ...
    /**
     * Profile a MessageReceived event. This method will gather the following informations : - the
     * method duration - the shortest execution time - the slowest execution time - the average
    ...
    /**
     * Profile a MessageSent event. This method will gather the following informations : - the
     * method duration - the shortest execution time - the slowest execution time - the average
     * execution time - the global number of calls
     *
     * @param nextFilter   The filter to call next
    ...
    /**
     * Profile a SessionCreated event. This method will gather the following informations : - the
     * method duration - the shortest execution time - the slowest execution time - the average
     * execution time - the global number of calls
     *
     * @param nextFilter The filter to call next
    ...
    /**
     * Profile a SessionOpened event. This method will gather the following informations : - the
     * method duration - the shortest execution time - the slowest execution time - the average
     * execution time - the global number of calls
     *
     * @param nextFilter The filter to call next
    ...
    /**
     * Profile a SessionIdle event. This method will gather the following informations : - the
     * method duration - the shortest execution time - the slowest execution time - the average
     * execution time - the global number of calls
     *
     * @param nextFilter The filter to call next
    ...
    /**
     * Profile a SessionClosed event. This method will gather the following informations : - the
     * method duration - the shortest execution time - the slowest execution time - the average
     * execution time - the global number of calls
     *
     * @param nextFilter The filter to call next
     ...
     *
     * @param type The {@link IoEventType} that the user wants to get the average method call time
    ...
    /**
     * Gets the total number of times the method has been called that is represented by the {@link
     * IoEventType}
     *
     * @param type The {@link IoEventType} that the user wants to get the total number of method
     *             calls
     * @return The total number of method calls for the method represented by the {@link
     * IoEventType}
     */
     ...
     *
     * @param type The {@link IoEventType} that the user wants to get the minimum time this method
     *             has executed
     ...
     *
     * @param type The {@link IoEventType} that the user wants to get the maximum time this method
     *             has executed
    ...
    private class TimerWorker {
         ...
         *
         * @param duration The new operation duration
         */
