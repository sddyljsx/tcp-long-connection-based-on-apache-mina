 ...
 * was used for estimation.  For unknown types, it inspects declaring fields of the class of the
 * specified event and the parameter of the event.  The size of unknown declaring fields are
 * approximated to the specified <tt>averageSizePerField</tt> (default: 64).
 * <p>
