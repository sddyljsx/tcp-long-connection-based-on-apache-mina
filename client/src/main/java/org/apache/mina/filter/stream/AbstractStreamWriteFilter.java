...
public abstract class AbstractStreamWriteFilter<T> extends IoFilterAdapter {
    ...
    /**
     * Returns the size of the write buffer in bytes. Data will be read from the stream in chunks of
     * this size and then written to the next filter.
     *
    ...
    /**
     * Sets the size of the write buffer in bytes. Data will be read from the stream in chunks of
     * this size and then written to the next filter.
     *
