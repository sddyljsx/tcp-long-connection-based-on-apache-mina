...
/**
 * A {@link ProtocolEncoder} which encodes a string using a fixed-length length prefix.
 *
...
public class PrefixedStringEncoder extends ProtocolEncoderAdapter {
     ...
     * <p>
     * The encoder will throw a {@link IllegalArgumentException} when more bytes are needed to
     * encode a String value. The default value is {@link PrefixedStringEncoder#DEFAULT_MAX_DATA_LENGTH}.
     * </p>
     *
