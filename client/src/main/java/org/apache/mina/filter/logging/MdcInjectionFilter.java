 ...
 * <p/>
 * These properties will be set in the MDC for all logging events that are generated down the call
 * stack, even in code that is not aware of MINA.
 * <p>
...
public class MdcInjectionFilter extends CommonEventFilter {
    ...
    /**
     * Use this constructor when you want to specify which keys to add to the MDC. You could still
     * add custom keys via {@link #setProperty(IoSession, String, String)}
     *
    ...
    /**
     * write key properties of the session to the Mapped Diagnostic Context sub-classes could
     * override this method to map more/other attributes
     *
    ...
    /**
     * Add a property to the context for the given session This property will be added to the MDC
