...
/**
 * A {@link ProtocolCodecFactory} that performs encoding and decoding between a text line data and a
 * Java string object.  This codec is useful especially when you work with a text-based protocols
 * such as SMTP and IMAP.
 *
...
public class TextLineCodecFactory implements ProtocolCodecFactory {
    ...
    /**
     * Creates a new instance with the specified {@link Charset}.  The encoder uses a UNIX {@link
     * LineDelimiter} and the decoder uses the AUTO {@link LineDelimiter}.
     *
    ...
    /**
     * Returns the allowed maximum size of the encoded line. If the size of the encoded line exceeds
    ...
    /**
     * Sets the allowed maximum size of the encoded line. If the size of the encoded line exceeds
     * this value, the encoder will throw a {@link IllegalArgumentException}.  The default value is
     * {@link Integer#MAX_VALUE}.
     * <p>
    ...
    /**
     * Returns the allowed maximum size of the line to be decoded. If the size of the line to be
     * decoded exceeds this value, the decoder will throw a {@link BufferDataException}.  The
     * default value is <tt>1024</tt> (1KB).
     * <p>
    ...
    /**
     * Sets the allowed maximum size of the line to be decoded. If the size of the line to be
     * decoded exceeds this value, the decoder will throw a {@link BufferDataException}.  The
     * default value is <tt>1024</tt> (1KB).
     * <p>
