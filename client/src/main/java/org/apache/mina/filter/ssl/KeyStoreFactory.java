...
public class KeyStoreFactory {
    ...
    /**
     * Creates a new {@link KeyStore}. This method will be called by the base class when Spring
     * creates a bean using this FactoryBean.
     *
    ...
    /**
     * Sets the key store password. If this value is <code>null</code> no password will be used to
     * check the integrity of the key store.
     *
    ...
    /**
     * Sets the name of the provider to use when creating the key store. The default is to use the
