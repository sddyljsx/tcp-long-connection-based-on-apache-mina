...
public class BlacklistFilter extends IoFilterAdapter {
     ...
     * NOTE: this call will remove any previously blacklisted addresses.
     *
     * @param addresses a collection of InetAddress objects representing the addresses to be
     *                  blacklisted.
     * @throws IllegalArgumentException if the specified collections contains non-{@link
     *                                  InetAddress} objects.
     */
