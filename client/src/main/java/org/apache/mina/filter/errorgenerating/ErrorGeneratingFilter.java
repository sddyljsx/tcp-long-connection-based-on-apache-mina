...
/**
 * An {@link IoFilter} implementation generating random bytes and PDU modification in your
 * communication streams. It's quite simple to use :
 * <code>ErrorGeneratingFilter egf = new ErrorGeneratingFilter();</code>
 * For activate the change of some bytes in your {@link IoBuffer}, for a probability of 200 out of
 * 1000 {@link IoBuffer} processed :
 * <code>egf.setChangeByteProbability(200);</code>
 * For activate the insertion of some bytes in your {@link IoBuffer}, for a probability of 200 out
 * of 1000 :
...
public class ErrorGeneratingFilter extends IoFilterAdapter {
    ...
    /**
     * Set the probability for the change byte error. If this probability is > 0 the filter will
     * modify a random number of byte of the processed {@link IoBuffer}.
     *
     * @param changeByteProbability probability of modifying an IoBuffer out of 1000 processed
     *                              {@link IoBuffer}
     */
    ...
    /**
     * Set the probability for the insert byte error. If this probability is > 0 the filter will
     * insert a random number of byte in the processed {@link IoBuffer}.
     *
     * @param insertByteProbability probability of inserting in IoBuffer out of 1000 processed
     *                              {@link IoBuffer}
     */
    ...
    /**
     * Set the probability for the remove byte error. If this probability is > 0 the filter will
     * remove a random number of byte in the processed {@link IoBuffer}.
     *
     * @param removeByteProbability probability of modifying an {@link IoBuffer} out of 1000
     *                              processed IoBuffer
     */
    ...
    /**
     * Set the maximum number of byte the filter can insert in a {@link IoBuffer}. The default value
     * is 10.
     *
