...
/**
 * {@link DecodingState} which consumes all received bytes until a configured number of read bytes
 * has been reached. Please note that this state can produce a buffer with less data than the
 * configured length if the associated session has been closed unexpectedly.
 *
