...
/**
 * A {@link ProtocolCodecFactory} that performs encoding and decoding of a Java String object using
 * a fixed-length length prefix.
 *
...
public class PrefixedStringCodecFactory implements ProtocolCodecFactory {
     ...
     * <p>
     * Useful for preventing an OutOfMemory attack by the peer. The decoder will throw a {@link
     * BufferDataException} when data length specified in the incoming data is greater than
     * maxDataLength The default value is {@link PrefixedStringDecoder#DEFAULT_MAX_DATA_LENGTH}.
     * <p>
