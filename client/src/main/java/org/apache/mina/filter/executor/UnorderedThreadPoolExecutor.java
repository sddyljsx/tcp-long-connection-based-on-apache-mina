...
/**
 * A {@link ThreadPoolExecutor} that does not maintain the order of {@link IoEvent}s. This means
 * more than one event handler methods can be invoked at the same time with mixed order.  For
 * example, let's assume that messageReceived, messageSent, and sessionClosed events are fired.
 * <ul>
