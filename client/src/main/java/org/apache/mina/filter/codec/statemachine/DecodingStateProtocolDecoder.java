...
/**
 * {@link ProtocolDecoder} which uses a {@link DecodingState} to decode data. Use a {@link
 * DecodingStateMachine} as {@link DecodingState} to create a state machine which can decode your
 * protocol.
 * <p>
...
public class DecodingStateProtocolDecoder implements ProtocolDecoder {
    ...
    /**
     * Creates a new instance using the specified {@link DecodingState} instance.
     *
