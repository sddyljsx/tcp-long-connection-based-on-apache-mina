...
/**
 * A {@link ProtocolCodecFactory} that serializes and deserializes Java objects. This codec is very
 * useful when you have to prototype your application rapidly without any specific codec.
 *
...
public class ObjectSerializationCodecFactory implements ProtocolCodecFactory {
    ...
    /**
     * Creates a new instance with the {@link ClassLoader} of the current thread.
     */
    ...
    /**
     * Returns the allowed maximum size of the encoded object. If the size of the encoded object
     * exceeds this value, the encoder will throw a {@link IllegalArgumentException}.  The default
     * value is {@link Integer#MAX_VALUE}.
     * <p>
    ...
    /**
     * Sets the allowed maximum size of the encoded object. If the size of the encoded object
     * exceeds this value, the encoder will throw a {@link IllegalArgumentException}.  The default
     * value is {@link Integer#MAX_VALUE}.
     * <p>
    ...
    /**
     * Returns the allowed maximum size of the object to be decoded. If the size of the object to be
     * decoded exceeds this value, the decoder will throw a {@link BufferDataException}.  The
     * default value is <tt>1048576</tt> (1MB).
     * <p>
    ...
    /**
     * Sets the allowed maximum size of the object to be decoded. If the size of the object to be
     * decoded exceeds this value, the decoder will throw a {@link BufferDataException}.  The
     * default value is <tt>1048576</tt> (1MB).
     * <p>
