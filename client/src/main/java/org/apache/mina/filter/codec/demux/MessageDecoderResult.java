...
public class MessageDecoderResult {
    /**
     * Represents a result from {@link MessageDecoder#decodable(IoSession, IoBuffer)} and {@link
     * MessageDecoder#decode(IoSession, IoBuffer, ProtocolDecoderOutput)}. Please refer to each
     * method's documentation for detailed explanation.
     */
