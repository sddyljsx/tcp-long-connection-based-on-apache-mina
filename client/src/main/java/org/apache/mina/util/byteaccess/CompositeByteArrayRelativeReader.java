...
public class CompositeByteArrayRelativeReader extends CompositeByteArrayRelativeBase implements IoRelativeReader {
    ...
    /**
     * Whether or not to free component <code>CompositeByteArray</code>s when the cursor moves past
     * them.
     */
     ...
     *
     * @param cba      The backing ByteArray
     * @param autoFree If data should be freed once it has been passed in the list
     */
    ...
    /**
     * places the data starting at current position into the supplied {@link IoBuffer}
     */
