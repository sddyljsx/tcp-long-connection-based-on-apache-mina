...
/**
 * This map is specially useful when reads are much more frequent than writes and if the cost of
 * instantiating the values is high like allocating an {@link IoBuffer} for example.
 * <p>
 * Based on the final implementation of Memoizer written by Brian Goetz and Tim Peierls. This
 * implementation will return an {@link UnsupportedOperationException} on each method that is not
 * intended to be called by user code for performance reasons.
 *
...
public class LazyInitializedCacheMap<K, V> implements Map<K, V> {
    ...
    /**
     * This class provides a noop {@link LazyInitializer} meaning it will return the same object it
     * received when instantiated.
     */
    ...
    /**
     * Default constructor. Uses the default parameters to initialize its internal {@link
     * ConcurrentHashMap}.
     */
    ...
    /**
     * This constructor allows to provide a fine tuned {@link ConcurrentHashMap} to stick with each
     * special case the user needs.
     */
    ...
    /**
     * @throws {@link UnsupportedOperationException} as this method would imply performance drops.
     */
