...
abstract class CompositeByteArrayRelativeBase {
    ...
    /**
     * A cursor of the underlying <code>CompositeByteArray</code>. This cursor is never moved
     * directly; its position only changes through calls to relative read or write methods.
     */
     ...
     *
     * @param cba The {@link CompositeByteArray} that will be the base for this class
     */
    ...
    /**
     * Called whenever the cursor has passed from the <code>cba</code>'s first component. As the
     * first component is no longer used, this provides a good opportunity for subclasses to perform
     * some action on it (such as freeing it).
     */
