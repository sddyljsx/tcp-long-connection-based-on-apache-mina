...
public class ExpiringMap<K, V> implements Map<K, V> {
    ...
    /**
     * Creates a new instance of ExpiringMap using the supplied values and a {@link
     * ConcurrentHashMap} for the internal data structure.
     *
     * @param timeToLive         The time-to-live value (seconds)
     * @param expirationInterval The time between checks to see if a value should be removed
     *                           (seconds)
     */
    ...
    /**
     * A Thread that monitors an {@link ExpiringMap} and will remove elements that have passed the
     * threshold.
     */
