...
/**
 * A <code>ByteArray</code> backed by a <code>IoBuffer</code>. This class is abstract. Subclasses
 * need to override the <code>free()</code> method. An implementation backed by a heap
 * <code>IoBuffer</code> can be created with a <code>SimpleByteArrayFactory</code>.
 *
...
public abstract class BufferByteArray extends AbstractByteArray {
    ...
    /**
     * Creates a new instance of BufferByteArray and uses the supplied {@link IoBuffer} to back this
     * class
     *
    ...
    /**
     * @inheritDoc Calling <code>free()</code> on the returned slice has no effect.
     */
