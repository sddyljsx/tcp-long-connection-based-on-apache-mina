...
/**
 * A ByteArray composed of other ByteArrays. Optimised for fast relative access via cursors.
 * Absolute access methods are provided, but may perform poorly.
 * <p>
 * TODO: Write about laziness of cursor implementation - how movement doesn't happen until actual
 * get/put.
 *
...
public final class CompositeByteArray extends AbstractByteArray {
     ...
     * Creates a new instance of CompositeByteArray.
     *
     * @param byteArrayFactory The factory used to create the ByteArray objects
     */
    ...
    /**
     * Remove component <code>ByteArray</code>s to the given index (splitting them if necessary) and
     * returning them in a single <code>ByteArray</code>. The caller is responsible for freeing the
     * returned object.
     * <p>
    ...
    /**
     * Get a cursor starting at index 0 (which may not be the start of the array) and with the given
     * listener.
     *
     * @param listener Returns a new {@link ByteArray.Cursor} instance
     */
