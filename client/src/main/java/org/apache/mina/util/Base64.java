...
public class Base64 {
    ...
    /**
     * Decodes an Object using the base64 algorithm.  This method is provided in order to satisfy
     * the requirements of the Decoder interface, and will throw a DecoderException if the supplied
     * object is not of type byte[].
     *
     * @param pObject Object to decode
     * @return An object (of type byte[]) containing the binary data which corresponds to the byte[]
     * supplied.
     * @throws InvalidParameterException if the parameter supplied is not of type byte[]
     */
    ...
    /**
     * Encodes an Object using the base64 algorithm.  This method is provided in order to satisfy
