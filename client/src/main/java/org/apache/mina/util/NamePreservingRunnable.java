...
/**
 * A {@link Runnable} wrapper that preserves the name of the thread after the runnable is complete
 * (for {@link Runnable}s that change the name of the Thread they use.)
 *
...
public class NamePreservingRunnable implements Runnable {
    ...
    /**
     * Run the runnable after having renamed the current thread's name to the new name. When the
     * runnable has completed, set back the current thread name back to its origin.
     */
    public void run() {
    ...
    /**
     * Wraps {@link Thread#setName(String)} to catch a possible {@link Exception}s such as {@link
