 ...
 * <p>
 * The generated xml corresponds 100% with what is generated by log4j's <a
 ...
 * <p>
 * The file and line attributes in the locationInfo element will always be "?" since
 * java.util.logging.LogRecord does not provide that info.
 * <p>
...
public class Log4jXmlFormatter extends Formatter {
     ...
     * means there will be no location information output by this layout. If the the option is set
     * to true, then the file name and line number of the statement at the origin of the log
