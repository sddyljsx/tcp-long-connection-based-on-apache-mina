...
/**
 * A thread-safe version of {@link Map} in which all operations that change the Map are implemented
 * by making a new copy of the underlying Map.
 * <p>
 * While the creation of a new Map can be expensive, this class is designed for cases in which the
 * primary function is to read data from the Map, not to modify the Map.  Therefore the operations
 * that do not cause a change to this class happen quickly and concurrently.
 *
...
public class CopyOnWriteMap<K, V> implements Map<K, V>, Cloneable {
    ...
    /**
     * Creates a new instance of CopyOnWriteMap in which the initial data being held by this map is
