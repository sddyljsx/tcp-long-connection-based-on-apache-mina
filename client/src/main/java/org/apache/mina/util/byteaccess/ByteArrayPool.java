...
public class ByteArrayPool implements ByteArrayFactory {
     ...
     *
     * @param direct         If we should use direct buffers
     * @param maxFreeBuffers The maximum number of free buffers
     * @param maxFreeMemory  The maximum amount of free memory allowed
     */
