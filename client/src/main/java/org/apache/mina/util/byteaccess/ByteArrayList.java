...
class ByteArrayList {
     ...
     * value of <code>next</code> is the first item in the list. The value of of
     * <code>previous</code> is the last item in the list.
     */
    ...
    /**
     * Adds the specified {@link ByteArray} to the beginning of the list
     *
     * @param ba The ByteArray to be added to the list
     */
    ...
    /**
     * Add the specified {@link ByteArray} to the end of the list
     *
     * @param ba The ByteArray to be added to the list
     */
     ...
     *
     * @return The node that was taken off of the list
     */
     ...
     * <p>
     * From Commons Collections 3.1, all access to the <code>value</code> property is via the
