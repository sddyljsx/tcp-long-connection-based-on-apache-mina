...
public class Transform {
     ...
     * and replaces any '<',  '>' , '&' or '"' characters with respective predefined entity
     * references.
     *
    ...
    /**
     * Ensures that embeded CDEnd strings (]]>) are handled properly within message, NDC and
     * throwable tag text.
     *
     * @param buf StringBuffer holding the XML data to this point.  The initial CDStart (<![CDATA[)
     *            and final CDEnd (]]>) of the CDATA section are the responsibility of the calling
     *            method.
