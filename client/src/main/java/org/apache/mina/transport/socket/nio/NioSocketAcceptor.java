...
/**
 * {@link IoAcceptor} for socket transport (TCP/IP).  This class handles incoming TCP/IP based
 * socket connections.
 *
...
public final class NioSocketAcceptor extends AbstractPollingIoAcceptor<NioSession, ServerSocketChannel>
    ...
    /**
     * Constructor for {@link NioSocketAcceptor} using default parameters, and given number of
    ...
    /**
     * Constructor for {@link NioSocketAcceptor} with default configuration but a specific {@link
    ...
    /**
     * Constructor for {@link NioSocketAcceptor} using default parameters, and given number of
     * {@link NioProcessor} for multithreading I/O operations, and a custom SelectorProvider for
     * NIO
     *
     * @param processorCount   the number of processor to create and place in a
     * @param selectorProvider teh SelectorProvider to use {@link SimpleIoProcessorPool}
     */
     ...
     * <p>
     * This method performs a blocking selection operation. It returns only after at least one
     * channel is selected, this selector's wakeup method is invoked, or the current thread is
    ...
    /**
     * Defines an iterator for the selected-key Set returned by the selector.selectedKeys(). It
     * replaces the SelectionKey operator.
     */
    private static class ServerSocketChannelIterator implements Iterator<ServerSocketChannel> {
        ...
        /**
         * Get the next SocketChannel in the operator we have built from the selected-key et for
         * this selector.
         *
