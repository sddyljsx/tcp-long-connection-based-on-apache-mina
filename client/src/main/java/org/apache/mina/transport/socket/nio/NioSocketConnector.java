...
public final class NioSocketConnector extends AbstractPollingIoConnector<NioSession, SocketChannel> implements
    ...
    /**
     * Constructor for {@link NioSocketConnector} with default configuration (multiple thread
     * model).
     */
    ...
    /**
     * Constructor for {@link NioSocketConnector} with default configuration, and given number of
     * {@link NioProcessor} for multithreading I/O operations
     *
     * @param processorCount the number of processor to create and place in a {@link
    ...
    /**
     * Constructor for {@link NioSocketConnector} with default configuration but a specific {@link
     * IoProcessor}, useful for sharing the same processor over multiple {@link IoService} of the
     * same type.
     *
    ...
    /**
     * Constructor for {@link NioSocketConnector} with default configuration which will use a
     * built-in thread pool executor to manage the given number of processor instances. The
     * processor class must have a constructor that accepts ExecutorService or Executor as its
     * single argument, or, failing that, a no-arg constructor.
     *
    ...
    /**
     * Constructor for {@link NioSocketConnector} with default configuration with default
     * configuration which will use a built-in thread pool executor to manage the default number of
     * processor instances. The processor class must have a constructor that accepts ExecutorService
     * or Executor as its single argument, or, failing that, a no-arg constructor. The default
     * number of instances is equal to the number of processor cores in the system, plus one.
     *
     * @param processorClass the processor class.
     * @see SimpleIoProcessorPool#SimpleIoProcessorPool(Class, Executor, int,
     * java.nio.channels.spi.SelectorProvider)
