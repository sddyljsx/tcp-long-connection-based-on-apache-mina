...
public interface SocketSessionConfig extends IoSessionConfig {
    ...
    /**
     * Please note that enabling <tt>SO_LINGER</tt> in Java NIO can result in platform-dependent
     * behavior and unexpected blocking of I/O thread.
     *
     * @see Socket#getSoLinger()
     * @see <a href="http://bugs.sun.com/bugdatabase/view_bug.do?bug_id=6179351">Sun Bug
     * Database</a>
     */
    int getSoLinger();
