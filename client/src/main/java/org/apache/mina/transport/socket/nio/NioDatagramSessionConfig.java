...
class NioDatagramSessionConfig extends AbstractDatagramSessionConfig {
    ...
    /**
     * Creates a new instance of NioDatagramSessionConfig, associated with the given
     * DatagramChannel.
     *
     ...
     * @throws RuntimeIoException if the socket is closed or if we had a SocketException
     ...
     * <br>
     * Note : The underlying Socket may not accept the new buffer's size. The user has to check that
     ...
     * @throws RuntimeIoException If the socket is closed or if we get an {@link SocketException}
     */
    ...
    /**
     * Get the current Traffic Class for this Socket, if any. As this is not a mandatory feature,
     * the returned value should be considered as a hint.
     *
