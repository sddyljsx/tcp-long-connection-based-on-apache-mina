...
public class HttpSmartProxyHandler extends AbstractHttpLogicHandler {
    ...
    /**
     * Automatic selection of the authentication algorithm. If <code>preferedOrder</code> is set
     * then algorithms are selected from the list order otherwise the algorithm tries to select the
     * most secured algorithm available first.
     *
