...
/**
 * ProxyIoSessionInitializer.java - {@link IoSessionInitializer} wrapper class to inject the {@link
 * ProxyIoSession} object that contains all the attributes of the target connection into the {@link
 * IoSession}.
 *
