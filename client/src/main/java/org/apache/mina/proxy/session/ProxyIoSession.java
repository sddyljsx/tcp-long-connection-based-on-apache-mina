...
/**
 * ProxyIoSession.java - Class that contains all informations for the current proxy authentication
 * session.
 *
...
public class ProxyIoSession {
    ...
    /**
     * The list contains the authentication methods to use. The order in the list is revelant : if
     * first method is available then it will be used etc ...
     */
    ...
    /**
     * A flag that indicates that the proxy closed the connection before handshake is done. So we
     * need to reconnect to the proxy to continue the handshaking process.
     */
    ...
    /**
     * Returns the list of the prefered order for the authentication methods. This list is used by
     * the {@link HttpSmartProxyHandler} to determine which authentication mechanism to use first
     * between those accepted by the proxy server. This list is only used when connecting to an http
     * proxy.
     */
    ...
    /**
     * Sets the {@link ProxyFilter}. Note : Please do not call this method from your code it could
    ...
    /**
     * Sets the {@link IoSession} in use. Note : Please do not call this method from your code it
     * could result in an unexpected behaviour.
     *
    ...
    /**
     * Sets the connector reference of this proxy session. Note : Please do not call this method
     * from your code it could result in an unexpected behaviour.
     *
    ...
    /**
     * Returns true if the current authentication process is not finished but the server has closed
     * the connection.
     */
    ...
    /**
     * Sets the reconnection needed flag. If set to true, it means that an authentication process is
     * currently running but the proxy server did not kept the connection alive. So we need to
     * reconnect to the server to complete the process. Note : Please do not call this method from
     * your code it could result in an unexpected behaviour.
     *
