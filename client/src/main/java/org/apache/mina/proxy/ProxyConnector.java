...
/**
 * ProxyConnector.java - Decorator for {@link SocketConnector} to provide proxy support, as
 * suggested by MINA list discussions.
 * <p>
 * Operates by intercepting connect requests and replacing the endpoint address with the proxy
 * address, then adding a {@link ProxyFilter} as the first {@link IoFilter} which performs any
 * necessary handshaking with the proxy before allowing data to flow normally. During the handshake,
 * any outgoing write requests are buffered.
 *
 * @author <a href="http://mina.apache.org">Apache MINA Project</a>
 * @see <a href="http://www.nabble.com/Meta-Transport%3A-an-idea-on-implementing-reconnection-and-proxy-td12969001.html">Proxy
 * reconnection</a>
...
public class ProxyConnector extends AbstractIoConnector {
    ...
    /**
     * Connects to the specified <code>address</code>.  If communication starts successfully, events
     * are fired to the connector's <code>handler</code>.
     *
    ...
    /**
     * Get the {@link SocketConnector} to be used for connections to the proxy server.
     */
    ...
    /**
     * Sets the {@link SocketConnector} to be used for connections to the proxy server.
     *
