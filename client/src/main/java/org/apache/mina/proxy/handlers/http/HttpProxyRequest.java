...
public class HttpProxyRequest extends ProxyRequest {
    ...
    /**
     * Constructor which creates a CONNECT request to the specified endpoint using the provided
     * protocol version.
     *
     * @param endpointAddress the endpoint to connect to
    ...
    /**
     * Constructor which creates a CONNECT request to the specified endpoint using the provided
     * protocol version and setting the requested headers.
     *
     * @param endpointAddress the endpoint to connect to
     * @param httpVersion     the HTTP protocol version
    ...
    /**
     * Constructor which creates a GET request to the specified http URI using the provided protocol
     * version
     *
     * @param httpURI     the target URI
     * @param httpVersion the HTTP protocol version
    ...
    /**
     * Constructor which creates a request using the provided HTTP verb targeted at the specified
     * http URI using the provided protocol version.
     *
    ...
    /**
     * Constructor which creates a request using the provided HTTP verb targeted at the specified
     * http URI using the provided protocol version and setting the requested headers.
     *
     * @param httpVerb    the HTTP verb to use
     * @param httpURI     the target URI
     * @param httpVersion the HTTP protocol version
