...
/**
 * NTLMResponses.java - Calculates the various Type 3 responses. Needs an MD4, MD5 and DES crypto
 * provider (Please note that default provider doesn't provide MD4).
 * <p>
 * Copyright (c) 2003 Eric Glass Permission to use, copy, modify, and distribute this document for
 * any purpose and without any fee is hereby granted, provided that the above copyright notice and
 * this list of conditions appear in all copies.
 *
...
public class NTLMResponses {
     ...
     * target, username, password, target information block, and client nonce.
     *
     ...
     * target, username, password, and client challenge.
     *
     * @param target      The authentication target (i.e., domain).
     * @param user        The username.
     * @param password    The user's password.
    ...
    /**
     * Calculates the NTLM2 Session Response for the given challenge, using the specified password
     * and client nonce.
     *
     * @param password    The user's password.
     * @param challenge   The Type 2 challenge from the server.
     ...
     * message; the LM response field contains the client nonce, null-padded to 24 bytes.
     */
     ...
     *
     * @param password The password.
     * @return The NTLM Hash of the given password, used in the calculation of the NTLM Response and
     * the NTLMv2 and LMv2 Hashes.
     */
     ...
     * @return A DES encryption key created from the key material starting at the specified offset
