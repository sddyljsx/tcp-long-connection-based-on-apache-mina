...
public class ByteUtilities {
    ...
    /**
     * Encodes an integer into up to 4 bytes in network byte order in the supplied buffer starting
     * at <code>start</code> offset and writing
    ...
    /**
     * Write a 16 bit short as LITTLE_ENDIAN to the given array <code>b</code> at offset
     * <code>offset</code>.
     *
     * @param v      the short to write
    ...
    /**
     * Write a 32 bit int as LITTLE_ENDIAN to the given array <code>b</code> at offset
     * <code>offset</code>.
     *
     * @param v      the int to write
     * @param b      the byte array to write to
    ...
    /**
     * Invert the endianness of words (4 bytes) in the given byte array starting at the given offset
     * and repeating length/4 times. eg: b0b1b2b3 -> b3b2b1b0
     *
     * @param b      the byte array
     * @param offset the offset at which to change word start
     * @param length the number of bytes on which to operate (should be a multiple of 4)
     */
    ...
    /**
     * Invert two bytes in the given byte array starting at the given offset and repeating the
     * inversion length/2 times. eg: b0b1 -> b1b0
     *
     * @param b      the byte array
     * @param offset the offset at which to change word start
     * @param length the number of bytes on which to operate (should be a multiple of 2)
     */
     ...
     * <code>useUnicode</code> argument.
     *
     * @param s          the string to encode
     * @param useUnicode if true then string is encoded to UTF-16LE otherwise to ASCII
     ...
     *
     * @param bytes     the array to output to an hex string
     * @param separator the separator to use between each byte in the output string. If null no char
     *                  is inserted between each byte value.
     * @return the hex representation as a string
     */
