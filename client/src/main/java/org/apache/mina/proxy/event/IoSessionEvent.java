...
public class IoSessionEvent {
    ...
    /**
     * The idle status if type value is {@link IoSessionEventType#IDLE}, null otherwise.
     */
    private IdleStatus status;

    /**
     * Creates an instance of this class when event type differs from {@link
    ...
    /**
     * Creates an instance of this class when event type is {@link IoSessionEventType#IDLE}.
     *
     * @param nextFilter the next filter
     * @param session    the session
     ...
     * @param type       the event type
     * @param status     the idle status should only be non null only if the event type is {@link
     *                   IoSessionEventType#IDLE}
     */
