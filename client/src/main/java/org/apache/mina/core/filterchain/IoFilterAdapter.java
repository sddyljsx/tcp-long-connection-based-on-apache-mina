...
/**
 * An adapter class for {@link IoFilter}.  You can extend this class and selectively override
 * required event filter methods only.  All methods forwards events to the next filter by default.
 *
