...
public interface ConnectFuture extends IoFuture {
    ...
    /**
     * Returns {@code true} if the connect operation has been canceled by {@link #cancel()} method.
     */
    boolean isCanceled();

    /**
     * Sets the newly connected session and notifies all threads waiting for this future.  This
     * method is invoked by MINA internally.  Please do not call this method directly.
     */
    void setSession(IoSession session);

    /**
     * Sets the exception caught due to connection failure and notifies all threads waiting for this
     * future.  This method is invoked by MINA internally.  Please do not call this method
     * directly.
     */
