 ...
 * and terminal {@link IoHandler} sequentially. Every {@link IoSession} has its own {@link
...
public interface IoFilterChain {
    ...
    /**
     * Returns the {@link Entry} with the specified <tt>filterType</tt> in this chain. If there's
     * more than one filter with the specified type, the first match will be chosen.
     *
    ...
    /**
     * Returns the {@link IoFilter} with the specified <tt>filterType</tt> in this chain. If there's
     * more than one filter with the specified type, the first match will be chosen.
     *
    ...
    /**
     * Returns the {@link NextFilter} of the {@link IoFilter} with the specified <tt>name</tt> in
     * this chain.
     *
    ...
    /**
     * Returns the {@link NextFilter} of the specified <tt>filterType</tt> in this chain.  If
     * there's more than one filter with the specified type, the first match will be chosen.
     *
    ...
    /**
     * Replace the filter of the specified type with the specified new filter.  If there's more than
     * one filter with the specified type, the first match will be replaced.
     *
    ...
    /**
     * Fires a {@link IoHandler#sessionCreated(IoSession)} event. Most users don't need to call this
    ...
    /**
     * Fires a {@link IoHandler#sessionOpened(IoSession)} event. Most users don't need to call this
     * method at all. Please use this method only when you implement a new transport or fire a
     * virtual event.
     */
    ...
    /**
     * Fires a {@link IoHandler#sessionClosed(IoSession)} event. Most users don't need to call this
     * method at all. Please use this method only when you implement a new transport or fire a
     * virtual event.
     */
    ...
    /**
     * Fires a {@link IoHandler#sessionIdle(IoSession, IdleStatus)} event. Most users don't need to
     * call this method at all. Please use this method only when you implement a new transport or
    ...
    /**
     * Fires a {@link IoHandler#messageReceived(IoSession, Object)} event. Most users don't need to
     * call this method at all. Please use this method only when you implement a new transport or
     * fire a virtual event.
     *
     ...
     * this method at all. Please use this method only when you implement a new transport or fire a
     * virtual event.
     *
    ...
    /**
     * Fires a {@link IoHandler#exceptionCaught(IoSession, Throwable)} event. Most users don't need
     * to call this method at all. Please use this method only when you implement a new transport or
     * fire a virtual event.
     *
    ...
    /**
     * Fires a {@link IoHandler#inputClosed(IoSession)} event. Most users don't need to call this
     * method at all. Please use this method only when you implement a new transport or fire a
     * virtual event.
     */
    ...
    /**
     * Fires a {@link IoSession#write(Object)} event. Most users don't need to call this method at
     * all. Please use this method only when you implement a new transport or fire a virtual event.
     *
    ...
    /**
     * Fires a {@link IoSession#close()} event. Most users don't need to call this method at all.
