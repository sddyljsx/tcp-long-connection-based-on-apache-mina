...
public class IoServiceStatistics {
    ...
    /**
     * @return The maximum number of sessions which were being managed at the same time.
     */
    ...
    /**
     * @return The cumulative number of sessions which were managed (or are being managed) by this
    ...
    /**
     * @return the time in millis when the last I/O operation (read or write) occurred.
     */
    ...
    /**
     * @return The maximum number of bytes read per second since the service has been started.
     */
    ...
    /**
     * @return The maximum number of bytes written per second since the service has been started.
     */
    ...
    /**
     * @return The maximum number of messages read per second since the service has been started.
     */
    ...
    /**
     * @return The maximum number of messages written per second since the service has been started.
     */
    ...
    /**
     * @return the interval (seconds) between each throughput calculation. The default value is
     * <tt>3</tt> seconds.
     */
     ...
     *
     * @param lastReadTime The last time a read has occurred
     */
     ...
     *
     * @param lastWriteTime The last time a write has occurred
     */
    ...
    /**
     * Increases the count of read bytes by <code>nbBytesRead</code> and sets the last read time to
     * <code>currentTime</code>.
     *
     * @param nbBytesRead The number of bytes read
     * @param currentTime The date those bytes were read
     */
     ...
     * <code>currentTime</code>.
     *
     * @param currentTime The time the message has been read
     */
    ...
    /**
     * Increases the count of written bytes by <code>nbBytesWritten</code> and sets the last write
     * time to <code>currentTime</code>.
     *
     * @param nbBytesWritten The number of bytes written
     * @param currentTime    The date those bytes were written
     */
     ...
     * <code>currentTime</code>.
     *
     * @param currentTime The date the message were written
     */
