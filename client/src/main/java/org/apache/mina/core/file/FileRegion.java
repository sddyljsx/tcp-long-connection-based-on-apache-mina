...
public interface FileRegion {
    ...
    /**
     * Updates the current file position based on the specified amount. This increases the value
     * returned by {@link #getPosition()} and {@link #getWrittenBytes()} by the given amount and
     * decreases the value returned by {@link #getRemainingBytes()} by the given {@code amount}.
     *
     ...
     *
     * @return the absolute filename, or <tt>null</tt> if the FileRegion does not know the filename
     */
    String getFilename();
}
