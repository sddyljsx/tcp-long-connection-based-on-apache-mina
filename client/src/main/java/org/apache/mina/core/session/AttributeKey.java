...
/**
 * Creates a Key from a class name and an attribute name. The resulting Key will be stored in the
 * session Map.<br> For instance, we can create a 'processor' AttributeKey this way :
 *
 * <pre>
 ...
 * </pre>
 * <p>
 * This will create the <b>SimpleIoProcessorPool.processor@7DE45C99</b> key which will be stored in
 * the session map.<br> Such an attributeKey is mainly useful for debug purposes.
 *
