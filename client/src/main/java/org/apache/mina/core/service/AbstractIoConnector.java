...
public abstract class AbstractIoConnector extends AbstractIoService implements IoConnector {
    ...
    /**
     * Constructor for {@link AbstractIoConnector}. You need to provide a default session
     ...
     *
     * @return The minimum time that this connector can have for a connection timeout in
     * milliseconds.
     */
    ...
    /**
     * @deprecated Take a look at <tt>setConnectTimeoutMillis(long)</tt>
     */
    ...
    /**
     * Adds required internal attributes and {@link IoFutureListener}s related with event
     * notifications to the specified {@code session} and {@code future}.  Do not call this method
     * directly;
     */
    @Override
