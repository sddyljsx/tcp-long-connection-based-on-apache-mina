...
/**
 * An I/O event or an I/O request that MINA provides. Most users won't need to use this class.  It
 * is usually used by internal components to store I/O events.
 *
