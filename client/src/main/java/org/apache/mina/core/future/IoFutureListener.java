...
public interface IoFutureListener<F extends IoFuture> extends EventListener {
    /**
     * An {@link IoFutureListener} that closes the {@link IoSession} which is associated with the
     * specified {@link IoFuture}.
     */
    ...
    /**
     * Invoked when the operation associated with the {@link IoFuture} has been completed even if
     * you add the listener after the completion.
     *
