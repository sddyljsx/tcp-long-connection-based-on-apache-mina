 ...
 * Opteron Italy 270 processors, {@link CachedBufferAllocator} outperformed {@link
...
public class CachedBufferAllocator implements IoBufferAllocator {
     ...
     * @param maxCachedBufferSize the maximum capacity of a cached buffer. A buffer whose capacity
     ...
     * value is not pooled.  <tt>0</tt> means 'no limitation'.
     */
