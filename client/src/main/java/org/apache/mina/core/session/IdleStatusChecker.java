...
/**
 * Detects idle sessions and fires <tt>sessionIdle</tt> events to them. To be used for service
 * unable to trigger idle events alone, like VmPipe or SerialTransport. Polling base transport are
 * advised to trigger idle events alone, using the poll/select timeout.
 *
