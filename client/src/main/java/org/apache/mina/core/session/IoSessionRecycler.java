...
/**
 * A connectionless transport can recycle existing sessions by assigning an {@link
 * IoSessionRecycler} to an {@link IoService}.
 *
...
public interface IoSessionRecycler {
    /**
     * A dummy recycler that doesn't recycle any sessions.  Using this recycler will make all
     * session lifecycle events to be fired for every I/O for all connectionless sessions.
     */
     ...
     *
     * @param remoteAddress the remote socket address of the {@link IoSession} the transport wants
     *                      to recycle.
