...
/**
 * An interface that builds {@link IoFilterChain} in predefined way when {@link IoSession} is
 * created.  You can extract common filter chain modification logic to this interface.  For example,
