...
/**
 * A filter which intercepts {@link IoHandler} events like Servlet filters.  Filters can be used for
 * these purposes:
 * <ul>
 *   <li>Event logging,</li>
...
public interface IoFilter {
    /**
     * Invoked by {@link ReferenceCountingFilter} when this filter is added to a {@link
     * IoFilterChain} at the first time, so you can initialize shared resources.  Please note that
     * this method is never called if you don't wrap a filter with {@link ReferenceCountingFilter}.
     */
    void init() throws Exception;

    /**
     * Invoked by {@link ReferenceCountingFilter} when this filter is not used by any {@link
     * IoFilterChain} anymore, so you can destroy shared resources.  Please note that this method is
     * never called if you don't wrap a filter with {@link ReferenceCountingFilter}.
     */
    void destroy() throws Exception;

    /**
     * Invoked before this filter is added to the specified <tt>parent</tt>. Please note that this
     * method can be invoked more than once if this filter is added to more than one parents.  This
     * method is not invoked before {@link #init()} is invoked.
     *
     * @param parent     the parent who called this method
     * @param name       the name assigned to this filter
     * @param nextFilter the {@link NextFilter} for this filter.  You can reuse this object until
     *                   this filter is removed from the chain.
     */
    void onPreAdd(IoFilterChain parent, String name, NextFilter nextFilter) throws Exception;

    /**
     * Invoked after this filter is added to the specified <tt>parent</tt>. Please note that this
     * method can be invoked more than once if this filter is added to more than one parents.  This
     * method is not invoked before {@link #init()} is invoked.
     *
     * @param parent     the parent who called this method
    ...
    /**
     * Invoked before this filter is removed from the specified <tt>parent</tt>. Please note that
     * this method can be invoked more than once if this filter is removed from more than one
     * parents. This method is always invoked before {@link #destroy()} is invoked.
     *
     * @param parent     the parent who called this method
     * @param name       the name assigned to this filter
     * @param nextFilter the {@link NextFilter} for this filter.  You can reuse this object until
    ...
    /**
     * Invoked after this filter is removed from the specified <tt>parent</tt>. Please note that
     * this method can be invoked more than once if this filter is removed from more than one
     * parents. This method is always invoked before {@link #destroy()} is invoked.
     *
     * @param parent     the parent who called this method
