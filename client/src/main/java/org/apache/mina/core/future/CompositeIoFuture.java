...
/**
 * An {@link IoFuture} of {@link IoFuture}s.  It is useful when you want to get notified when all
 * {@link IoFuture}s are complete.  It is not recommended to use {@link CompositeIoFuture} if you
 * just want to wait for all futures. In that case, please use {@link IoUtil#await(Iterable)}
