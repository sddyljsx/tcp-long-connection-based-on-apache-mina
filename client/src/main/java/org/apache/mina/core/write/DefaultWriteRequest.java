...
public class DefaultWriteRequest implements WriteRequest {
    ...
    /**
     * Creates a new instance without {@link WriteFuture}.  You'll get an instance of {@link
     * WriteFuture} even if you called this constructor because {@link #getFuture()} will return a
     * bogus future.
     */
     ...
     * @param destination the destination of the message.  This property will be ignored unless the
