...
public abstract class AbstractIoSession implements IoSession {
    ...
    /**
     * Set the scheduledForFLush flag. As we may have concurrent access to this flag, we compare and
     * set it in one call.
     *
    ...
    /**
     * {@inheritDoc} TODO This is a ridiculous implementation. Need to be replaced.
     */
    @Override
    ...
    /**
     * Fires a {@link IoEventType#SESSION_IDLE} event to any applicable sessions in the specified
     * collection.
     *
    ...
    /**
     * Fires a {@link IoEventType#SESSION_IDLE} event if applicable for the specified {@code
     * session}.
     *
     * @param currentTime the current time (i.e. {@link System#currentTimeMillis()})
     */
     ...
     * <p>
     * TODO : Check that when closing a session, all the pending requests are correctly sent.
     */
