...
/**
 * A utility class that provides various convenience methods related with {@link IoSession} and
 * {@link IoFuture}.
 *
...
public class IoUtil {
    ...
    /**
     * Writes the specified {@code message} to the specified {@code sessions}. If the specified
     * {@code message} is an {@link IoBuffer}, the buffer is automatically duplicated using {@link
     * IoBuffer#duplicate()}.
     */
