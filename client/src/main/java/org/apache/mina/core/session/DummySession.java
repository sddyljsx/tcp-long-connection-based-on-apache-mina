...
/**
 * A dummy {@link IoSession} for unit-testing or non-network-use of the classes that depends on
 * {@link IoSession}.
 *
 * <h2>Overriding I/O request methods</h2>
 * All I/O request methods (i.e. {@link #close()}, {@link #write(Object)} are final and therefore
 * cannot be overridden, but you can always add your custom {@link IoFilter} to the {@link
 * IoFilterChain} to intercept any I/O events and requests.
 *
...
public class DummySession extends AbstractIoSession {
    ...
    /**
     * Update all statistical properties related with throughput.  By default this method returns
     * silently without updating the throughput properties if they were calculated already within
     * last {@link IoSessionConfig#getThroughputCalculationInterval() calculation interval}. If,
     * however, <tt>force</tt> is specified as <tt>true</tt>, this method updates the throughput
