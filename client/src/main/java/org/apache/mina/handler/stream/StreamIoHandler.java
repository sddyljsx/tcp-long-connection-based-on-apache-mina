 ...
 * <p>
 * Please extend this class and implement {@link #processStreamIo(IoSession, InputStream,
 * OutputStream)} to execute your stream I/O logic; <b>please note that you must forward the process
 * request to other thread or thread pool.</b>
 *
...
public abstract class StreamIoHandler extends IoHandlerAdapter {
    ...
    /**
     * Returns read timeout in seconds. The default value is <tt>0</tt> (disabled).
     */
    ...
    /**
     * Returns write timeout in seconds. The default value is <tt>0</tt> (disabled).
     */
    ...
    /**
     * Sets write timeout in seconds. The default value is <tt>0</tt> (disabled).
     */
