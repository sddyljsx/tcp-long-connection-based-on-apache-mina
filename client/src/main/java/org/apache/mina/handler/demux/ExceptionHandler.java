 ...
 * handler with the type of exception you want to get notified using {@link
...
public interface ExceptionHandler<E extends Throwable> {
    /**
     * A {@link ExceptionHandler} that does nothing.  This is useful when you want to ignore an
     * exception of a specific type silently.
     */
    ...
    /**
     * A {@link ExceptionHandler} that closes the session immediately. This is useful when you want
     * to close the session when an exception of a specific type is raised.
     */
