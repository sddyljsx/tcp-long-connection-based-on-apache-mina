...
/**
 * A {@link IoHandler} that demuxes <code>messageReceived</code> events to the appropriate {@link
 * MessageHandler}.
 * <p>
 * You can freely register and deregister {@link MessageHandler}s using {@link
 * #addReceivedMessageHandler(Class, MessageHandler)} and {@link #removeReceivedMessageHandler(Class)}.
 * </p>
 * <p>
 * When <code>message</code> is received through a call to {@link #messageReceived(IoSession,
 * Object)} the class of the
 * <code>message</code> object will be used to find a {@link MessageHandler} for
 * that particular message type. If no {@link MessageHandler} instance can be found for the
 * immediate class (i.e. <code>message.getClass()</code>) the interfaces implemented by the
 * immediate class will be searched in depth-first order. If no match can be found for any of the
 * interfaces the search will be repeated recursively for the superclass of the immediate class
 ...
 *    Object
 * </pre>
 * When <code>message</code> is of type <code>C3</code> this hierarchy will be searched in the
 * following order:
 * <code>C3, I7, I8, I9, I3, I4, C2, I5, I6, C1, I1, I2, I3, I4, Object</code>.
 * </p>
 * <p>
 * For efficiency searches will be cached. Calls to {@link #addReceivedMessageHandler(Class,
 * MessageHandler)} and {@link #removeReceivedMessageHandler(Class)} clear this cache.
 * </p>
 *
...
public class DemuxingIoHandler extends IoHandlerAdapter {
    ...
    /**
     * Registers a {@link MessageHandler} that handles the received messages of the specified
     * <code>type</code>.
     *
     * @return the old handler if there is already a registered handler for the specified
     * <tt>type</tt>.  <tt>null</tt> otherwise.
     */
    ...
    /**
     * Deregisters a {@link MessageHandler} that handles the received messages of the specified
     * <code>type</code>.
     *
    ...
    /**
     * Registers a {@link MessageHandler} that handles the sent messages of the specified
     * <code>type</code>.
     *
     * @return the old handler if there is already a registered handler for the specified
     * <tt>type</tt>.  <tt>null</tt> otherwise.
    ...
    /**
     * Deregisters a {@link MessageHandler} that handles the sent messages of the specified
     * <code>type</code>.
     *
     * @return the removed handler if successfully removed.  <tt>null</tt> otherwise.
     */
    ...
    /**
     * Registers a {@link MessageHandler} that receives the messages of the specified
     * <code>type</code>.
     *
     * @return the old handler if there is already a registered handler for the specified
     * <tt>type</tt>.  <tt>null</tt> otherwise.
    ...
    /**
     * Deregisters a {@link MessageHandler} that receives the messages of the specified
     * <code>type</code>.
     *
     * @return the removed handler if successfully removed.  <tt>null</tt> otherwise.
     */
    ...
    /**
     * Returns the {@link MessageHandler} which is registered to process the specified
     * <code>type</code>.
     */
    @SuppressWarnings("unchecked")
    ...
    /**
     * Returns the {@link Map} which contains all messageType-{@link MessageHandler} pairs
     * registered to this handler for received messages.
     */
    ...
    /**
     * Returns the {@link Map} which contains all messageType-{@link MessageHandler} pairs
     * registered to this handler for sent messages.
     */
    ...
    /**
     * Forwards the received events into the appropriate {@link MessageHandler} which is registered
     * by {@link #addReceivedMessageHandler(Class, MessageHandler)}.
     *
     * <b>Warning !</b> If you are to overload this method, be aware that you
     * _must_ call the messageHandler in your own method, otherwise it won't be called.
     */
    @Override
    ...
    /**
     * Invoked when any exception is thrown by user IoHandler implementation or by MINA. If cause is
     * an instance of IOException, MINA will close the connection automatically.
     *
     * <b>Warning !</b> If you are to overload this method, be aware that you
     * _must_ call the messageHandler in your own method, otherwise it won't be called.
     */
