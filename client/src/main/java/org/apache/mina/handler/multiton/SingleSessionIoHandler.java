 ...
 * <p>
 * A {@link SingleSessionIoHandler} is similar to an {@link IoHandler} with the notable difference
 * that a {@link SingleSessionIoHandler} is used only by one session at a time. Thus, there is no
 * {@link IoSession} parameter in the methods of this interface.
 * </p>
 * <p>
 * Because events are passed to the session in order, it is possible to store conversational state
 * as instance variables in this object.
 * </p>
 * <p>
 * WARNING: This class is badly named as the actual {@link IoHandler} implementor is in fact the
 * {@link SingleSessionIoHandlerDelegate}.
 *
