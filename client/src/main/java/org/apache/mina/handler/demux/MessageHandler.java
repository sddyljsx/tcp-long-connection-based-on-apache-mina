 ...
 * register your handler with the type of the message you want to get notified using {@link
 * DemuxingIoHandler#addReceivedMessageHandler(Class, MessageHandler)} or {@link
 * DemuxingIoHandler#addSentMessageHandler(Class, MessageHandler)}.
 *
 * @author <a href="http://mina.apache.org">Apache MINA Project</a>
 */
public interface MessageHandler<E> {
    /**
     * A {@link MessageHandler} that does nothing.  This is useful when you want to ignore a message
     * of a specific type silently.
     */
