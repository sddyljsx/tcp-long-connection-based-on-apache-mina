...
/**
 * Adapter class for implementors of the {@link SingleSessionIoHandler} interface. The session to
 * which the handler is assigned is accessible through the {@link #getSession()} method.
 *
